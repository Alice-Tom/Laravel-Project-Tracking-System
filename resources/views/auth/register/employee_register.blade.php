...
<html lang="en">
<head>
<title>PTS - Employee Register</title>
<meta charset="utf-8">
...
<div class="super_container">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header"><h4><center>{{ __('EMPLOYEE REGISTRATION') }}</h4></center></div>
    
                    <div class="card-body">
                        <form method="POST" action="{{ route('register.store', ['registration_type' => 'employee']) }}">
                            @csrf
