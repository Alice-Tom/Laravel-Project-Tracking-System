...
@include('includes.employee_topnav')                 
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Update {{$projects->project_title}} Project Progress</h1>
                    </div>
                    ...
                    {{-- add project progress form --}}
                        <div class="card o-hidden border-0 shadow-lg my-5">
                            <div class="card-body p-0">
                                ...
                                <div class="row">
                                    <div class="col-lg-5 d-none d-lg-block" style="background-image:url(../../images/projectgif.gif); background-repeat: no-repeat"></div>
                                    <div class="col-lg-7">
                                        <div class="p-5">
                                            <div class="text-center">
                                                <h1 class="h4 text-gray-900 mb-4">Edit Project Status</h1>
                                            </div>

                                            <form method="POST" action="{{ route('updatestatus', [$projects->id]) }}">
                                                @csrf
